-- Refactored ingest_signal RPC
-- Implements high-performance incremental scoring with diminishing returns,
-- anti-spam protection, and negative signal damping.
--
-- Logic: new_score = current_score + (impact * (1 - current_score / 100))
...
BEGIN
    ...
    -- new_score = current_score + (impact * (1 - current_score / 100))
    v_new_score := ROUND(
